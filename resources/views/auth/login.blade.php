...
<div class="login-card position-relative" style="overflow: hidden;">
            ...
            <form method="POST" action="{{ route('login') }}" id="loginForm">
                ...
                <div class="mb-3">
                    <label for="login" class="form-label">
                        <i class="fas fa-user me-2 text-primary"></i>Email o Username
                    </label>
                    <input id="login" 
                           type="text" 
                ...
                <div class="form-check mb-4">
                    ...
                    <label class="form-check-label" for="remember">
                        <i class="fas fa-heart me-1 text-danger"></i>Ricordami
                    </label>
                </div>
    ...
    <div class="text-center py-3" style="background: #f8f9fa; border-top: 1px solid #e9ecef; position: relative; z-index: 1;">
        <small class="text-muted">
            ...
            <a href="{{ route('home') }}" class="text-decoration-none">Torna al sito</a>
        </small>
    </div>
</div>
@endsection
