...
<div class="container my-5">
    ...
    <div class="row row-cols-1 row-cols-md-2 g-4">
        <div class="col d-flex align-items-start">
            ...
            <div>
                <h5>PayPal</h5>
                <p>Pagamenti con PayPal e Stripe</p>
            </div>
        </div>
        ...
        <div class="col d-flex align-items-start">
            ...
            <div>
                <h5>Rimborsi Gratuiti</h5>
                <p>Rimborsi Gratuiti entro 30 giorni dalla prenotazione</p>
            </div>
        </div>
        ...
        <div class="col d-flex align-items-start">
            ...
            <div>
                <h5>TV Smart</h5>
                <p>TV con accesso a Netflix, Disney+, Apple TV, YouTube e altri servizi.</p>
            </div>
        </div>
        ...
        <div class="col d-flex align-items-start">
            ...
            <div>
                ...
                <p>Le stanze principali sono dotate di aria condizionata.</p>
            </div>
        </div>
        ...
        <div class="col d-flex align-items-start">
            ...
            <div>
                ...
                <p>Divani, sedie e tavolo all'aperto per godersi il verde.</p>
            </div>
        </div>
