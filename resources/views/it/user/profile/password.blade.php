...
<div class="d-flex justify-content-center align-items-center" style="min-height: 100vh;">
    ...
    <div style="position: relative; z-index: 1;">
        ...
        <div class="login-header text-center">
            ...
            <p class="mb-0">Aggiorna le credenziali del tuo account</p>
        </div>
        ...
        <div class="login-body">
            ...
            @if($errors->any())
                <div class="alert alert-danger mb-4" role="alert">
                    ...
                    <strong>Errore!</strong> Controlla i dati inseriti.
                    <ul class="mb-0 mt-2">
            ...
            <form method="POST" action="{{ route('profile.password.update') }}">
                ...
                <div class="mb-3">
                    <label for="current_password" class="form-label">
                        <i class="fas fa-key me-2 text-primary"></i>Password attuale
                    </label>
                ...
                <div class="mb-3">
                    <label for="password" class="form-label">
                        <i class="fas fa-lock me-2 text-primary"></i>Nuova Password
                    </label>
                ...
                <div class="mb-3">
                    <label for="password_confirmation" class="form-label">
                        <i class="fas fa-check me-2 text-primary"></i>Conferma Nuova Password
                    </label>
    ...
    <div class="text-center py-3" style="background: #f8f9fa; border-top: 1px solid #e9ecef; position: relative; z-index: 1;">
        <small class="text-muted">
            ...
            <a href="{{ route('user.dashboard') }}" class="text-decoration-none">Torna alla Dashboard</a>
        </small>
    </div>
</div>
</div>
