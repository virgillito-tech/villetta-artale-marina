...
@section('title', 'Review - Villetta Artale Marina')
    ...
    <div class="card shadow-sm mx-auto" style="max-width: 600px;">
        <div class="card-body">
            <form action="{{ route('recensioni.store') }}" method="POST" novalidate>
                ...
                <div class="mb-3">
                    <label for="contenuto" class="form-label">Review</label>
                ...
                <div class="mb-4">
                    <label for="voto" class="form-label">Vote (1-5)</label>
                    <select id="voto" name="voto" class="form-select @error('voto') is-invalid @enderror" required>
                        <option value="" disabled selected>Select a vote</option>
                        @for($i = 1; $i <= 5; $i++)
                ...
                <button type="submit" class="btn btn-primary btn-lg w-100">
                    <i class="bi bi-send-fill"></i> Send Review
                </button>
            </form>
        </div>
    </div>
...
<div class="container my-4">
    <h3 class="mb-4 text-center">Our Reviews</h3>
          ...
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="reviewModalLabel{{ $recensione->id }}">{{ $recensione->nome }} - Review</h5>
