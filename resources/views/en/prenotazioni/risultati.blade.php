...
<div class="container my-5">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <h3 class="mb-4">Results of your search</h3>

            <ul class="list-group mb-3">
                <li class="list-group-item"><strong>Arrival date:</strong> {{ $inizio->format('d/m/Y') }}</li>
                <li class="list-group-item"><strong>Departure date:</strong> {{ $fine->format('d/m/Y') }}</li>
                <li class="list-group-item"><strong>Number of rooms:</strong> {{ $request->rooms }}</li>
                <li class="list-group-item"><strong>Number of people:</strong> {{ $request->guests }}</li>
                <li class="list-group-item">
                    <strong>Anailability:</strong>
                    @if($isAvailable)
                ...
                @if($isAvailable)
                    <li class="list-group-item"><strong>Total price:</strong> €{{ number_format($prezzoTotale, 2, ',', '.') }}</li>
                @endif
            </ul>
            ...
            @if($isAvailable)
                ...
                <h5 class="mt-4 mb-3">Pay with card or digital wallet (Stripe)</h5>
            ...
            @else
                <a href="{{ url('/') }}" class="btn btn-secondary">Return to search</a>
            @endif
