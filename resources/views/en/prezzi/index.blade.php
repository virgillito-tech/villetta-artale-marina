...
@include($locale . '.prezzi.partials.price-modal')
...
const storeUrl = '{{ route("admin.prezzi.store") }}';
const updateUrl = '{{ route("admin.prezzi.update", ":id") }}';
const deleteUrl = '{{ route("admin.prezzi.destroy", ":id") }}';
let calendar = null;
