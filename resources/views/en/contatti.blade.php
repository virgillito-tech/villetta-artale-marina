...
<div class="container-sfondo my-4">
    ...
    <p>📞 <strong>Phone:</strong> <a href="tel:+393454218671">+393454218671</a> or <a href="tel:+393409727744">+393409727744</a></p>
...
<div class="d-flex gap-4 flex-wrap">
  <div style="flex: 1; min-width: 300px;">
    <h4 class="mt-4 mb-3">Where you can find us: </h4>
...
@endif
    @else
      <div class="alert alert-secondary" role="alert">
        Unable to retrieve the weather at this time.
      </div>
    @endif
  </div>
