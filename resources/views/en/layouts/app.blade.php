...
.logo-header-round {
    ...
    <!-- <div style="position: fixed; top: 0; left: 0; background: yellow; color: red; font-weight: bold; padding: 8px; z-index: 9999;">
        DEBUG: Lingua attuale: {{ app()->getLocale() }}
    </div> -->
        <!-- Navbar -->
<nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarContent">
            ...
            <ul class="navbar-nav mx-auto text-center">
                ...
                <li class="nav-item"><a class="nav-link" href="{{ url('/galleria') }}">Gallery</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ url('/servizi') }}">Services</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ url('/recensioni') }}">Review</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ url('/contatti') }}">Contacts</a></li>
            </ul>
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">    
                                ...
                                @else
                                    <li><a class="dropdown-item" href="{{ route('user.dashboard') }}">
                                        <i class="fas fa-user me-2"></i> My Area
                                    </a></li>
    ...
    @if(!request()->routeIs('login', 'register'))
        ...
        <header class="bg-primary text-white text-center py-2">
            ...
            <p class="lead">Your holiday home by the sea and on the slopes of Etna</p>
        </header>
    @endif
