...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div class="me-3">
                    <a class="btn btn-outline-light btn-sm" href="{{ route('home') }}" target="_blank">
                        <i class="fas fa-external-link-alt me-1"></i> See Website
                    </a>
                </div>
    ...
    <header class="admin-header text-white text-center py-4">
        <div class="container position-relative">
            <h1><i class="fas fa-shield-alt me-2"></i>Area Admin</h1>
            <p class="lead mb-0">Management Villetta Artale Marina</p>
        </div>
    </header>
    ...
    <footer class="bg-dark text-white text-center py-4 mt-5">
        <div class="container">
            ...
            <span class="text-warning">
                <i class="fas fa-shield-alt me-1"></i>Area Admin
            </span>
        </div>
    </footer>
