...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        ...
        <a class="navbar-brand d-flex align-items-center" href="{{ url('/') }}">
            <img src="{{ asset('images/logo.jpg') }}" alt="Logo" class="img-fluid me-2" style="max-height: 50px;">
        ...
        <div class="collapse navbar-collapse" id="navbarContent">
            ...
            <div class="d-flex align-items-center me-3">
                ...
                <!-- Icone social accanto a Prenotazione -->
                <div class="d-flex align-items-center ms-4">
                    <a href="https://wa.me/393454218671" class="btn btn-outline-light btn-sm rounded-circle mx-1"><i class="fab fa-whatsapp"></i></a>
                    <a href="https://www.instagram.com/villetta_artale_marina" class="btn btn-outline-light btn-sm rounded-circle mx-1"><i class="fab fa-instagram"></i></a>
                    <a href="https://t.me/virgillito" class="btn btn-outline-light btn-sm rounded-circle mx-1"><i class="fab fa-telegram"></i></a>
                </div>
            </div>

            <!-- Menu utente / tasto Accedi più a destra e rotondo -->
            <!-- Menu utente / login -->
<ul class="navbar-nav ms-auto">
    @auth
        <!-- Utente loggato: icona + dropdown -->
    ...
    @else
        <!-- Utente non loggato: porta al login -->
