    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    <div class="space-x-4">
                        <a href="{{ route('login') }}" class="text-sm text-gray-700 dark:text-gray-500 hover:text-gray-900 dark:hover:text-gray-300">
                            {{ __('Login') }}
                        </a>
                        <a href="{{ route('register') }}" class="text-sm text-gray-700 dark:text-gray-500 hover:text-gray-900 dark:hover:text-gray-300">
                            {{ __('Register') }}
                        </a>
                    </div>
                @endauth
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            @else
                <div class="px-4 space-y-1">
                    <a href="{{ route('login') }}" class="block text-sm text-gray-700 dark:text-gray-500 hover:text-gray-900 dark:hover:text-gray-300">
                        {{ __('Login') }}
                    </a>
                    <a href="{{ route('register') }}" class="block text-sm text-gray-700 dark:text-gray-500 hover:text-gray-900 dark:hover:text-gray-300">
                        {{ __('Register') }}
                    </a>
                </div>
            @endauth
